...
from training.train import tri_train_one_epoch, evaluate
...
def main(args):
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        # test_zeroshot_3d_core(data["val"].dataloader, model, tokenizer=get_tokenizer(args.model), args=args)
        tri_train_one_epoch(
            model,
            data,
            loss,
        ...
        if any(v in data for v in ("val", "imagenet-val", "imagenet-v2")):
            ...
            test_metric = test_zeroshot_3d_core(
                data["val"].dataloader,
                model,
                tokenizer=get_tokenizer(args.model),
                args=args,
